        ...
        <div class="col-6">
            <form action="" class="form">
                ...
                <div class="form-group">
                    <input type="text" name="username" id="username" class="form-control" placeholder="Username" style="width: 400px; margin-bottom: 40px;">
                ...
                <div class="form-group">
                    ...
                    <p class="" id="err_password"></p>
                    <input type="checkbox" id="pass">
                    <label for="pass" class="show-pass">
                        <i class="fa fa-eye" id="togglePassword"></i>
                    </label>
                </div>
                <div class="text-center">
                    <a href="home" id="sign-in"><button type="button" class="btn1 mt-5">Sign In</button></a>
                </div>
